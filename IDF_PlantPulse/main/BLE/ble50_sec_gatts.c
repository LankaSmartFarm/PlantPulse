                                        ...
                                        esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    case ESP_GATTS_WRITE_EVT:
    {
        ...
        // decode command and take action here
        break;
    }
    ...
    case ESP_GATTS_CONNECT_EVT:
        ...
        //         // Update the characteristic value to "hi nrf"
        //         // esp_err_t set_attr_ret = esp_ble_gatts_set_attr_value(
        //         //     profile_handle_table[IDX_CHAR_VAL_A], // Handle for the characteristic
        //         //     sizeof(hi_nrf_message),              // Length of the message
        //         //     hi_nrf_message                       // Message content
        //         // );
        //         // if (set_attr_ret == ESP_OK) {
        //         //     ESP_LOGI(GATTS_TABLE_TAG, "Characteristic value updated: hi nrf");
        //         // } else {
        ...
        //         //     gatts_if,
        //         //     param->connect.conn_id,                // Connection ID
        //         //     profile_handle_table[IDX_CHAR_VAL_A],  // Handle for the characteristic
        //         //     sizeof(hi_nrf_message),                // Length of the message
        //         //     hi_nrf_message,                        // Message content
...
void sendOverBLE_soil_packet(soil_packet_t soil_packet,uint16_t total_len)
{
    ...
    esp_err_t notify_ret = esp_ble_gatts_send_indicate(
        heart_rate_profile_tab[HEART_PROFILE_APP_IDX].gatts_if,
        heart_rate_profile_tab[HEART_PROFILE_APP_IDX].conn_id, // Use actual connection ID
        profile_handle_table[IDX_CHAR_VAL_B],
        total_len,
        (uint8_t *)&soil_packet,
...
{
    // 1️⃣ Set BLE characteristic value
    esp_err_t set_attr_ret = esp_ble_gatts_set_attr_value(
        profile_handle_table[IDX_CHAR_VAL_B],
        total_len,
        (uint8_t *)&ping_packet
    ...
    // 2️⃣ Send BLE notification to connected client (app)
    esp_err_t notify_ret = esp_ble_gatts_send_indicate(
        heart_rate_profile_tab[HEART_PROFILE_APP_IDX].gatts_if,
        heart_rate_profile_tab[HEART_PROFILE_APP_IDX].conn_id, // ensure connection valid
        profile_handle_table[IDX_CHAR_VAL_B],
        total_len,
        (uint8_t *)&ping_packet,
